...
modelspath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'flow_pretrain_np/')
...
class MEBasic(nn.Module):
    def __init__(self, layername):
        ...
        self.conv1.weight.data, self.conv1.bias.data = load_weight_form_np(modelspath, layername + '_F-1')
        self.conv2 = nn.Conv2d(32, 64, 7, 1, padding=3)
        self.conv2.weight.data, self.conv2.bias.data = load_weight_form_np(modelspath, layername + '_F-2')
        self.conv3 = nn.Conv2d(64, 32, 7, 1, padding=3)
        self.conv3.weight.data, self.conv3.bias.data = load_weight_form_np(modelspath, layername + '_F-3')
        self.conv4 = nn.Conv2d(32, 16, 7, 1, padding=3)
        self.conv4.weight.data, self.conv4.bias.data = load_weight_form_np(modelspath, layername + '_F-4')
        self.conv5 = nn.Conv2d(16, 2, 7, 1, padding=3)
        self.conv5.weight.data, self.conv5.bias.data = load_weight_form_np(modelspath, layername + '_F-5')
